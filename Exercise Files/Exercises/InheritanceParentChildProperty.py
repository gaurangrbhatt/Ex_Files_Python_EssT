...
class son(parent):
    ...
    def son_display(self):
        # print("Total Asset Worth is "+str(self.total_asset)+" Million.")
        print("Share of Son is "+str(round(self.total_asset*(self.percentage_for_son/100), 2))+" Million.")
...
class daughter(parent):
    ...
    def daughter_display(self):
        # print("Total Asset Worth is "+str(self.total_asset)+" Million.")
        print("Share of Daughter is "+str(round(self.total_asset*(self.percentage_for_daughter/100), 2))+" Million.")
